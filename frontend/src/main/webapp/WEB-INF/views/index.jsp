  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="resources/images/one.jpg" alt="Samsung Phone" height="100%" width="100%">
      </div>
      ...
      <div class="item">
        <img src="resources/images/five.png" alt="New york" height="100%" width="100%">
      </div>
...
<br>
<!--  <h2><center><font face="trebuchet ms"><mark>Categories</mark><span class="glyphicon" style="color:#f4511e">&#xe042;</span></font></center></h2><br><br> -->
...
<hr>
<h2><center><font face="trebuchet ms"><mark> Deal of the Day </mark><span class="glyphicon" style="color:#f4511e">&#xe042;</span></center></h2><br><br>
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p><button class="button btn btn-success">&#8377;88,999</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        3300mAH battery</p>
        <p><button class="button btn btn-success">&#8377;34,999</button></p>
      </div>
    </div>
  </div>
  <div class="column">
...
3500 mAh Battery</p>
        <p><button class="button btn btn-success">&#8377;64,900</button></p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p><button class="button btn btn-success">&#8377;1,14,500</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        ...
        <p><button class="button btn btn-success">&#8377;2,24,900
</button></p>
      </div>
    </div>
  </div>
...
15.6 inch Touchscreen Display | 1 TB HDD|128 GB SSD</p>
        <p><button class="button btn btn-success">&#8377;1,20,000
</button></p>
      </div>
    </div>
  </div>
