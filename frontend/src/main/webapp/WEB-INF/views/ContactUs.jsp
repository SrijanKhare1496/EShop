      ...
      <div class="row text-center">
        <div class="col-sm-4">
          <div class="contact-detail-box">
            ...
            <h4>Get In Touch</h4>
            <abbr title="Phone">Phone :</abbr> 9407565645 <br>
            Email : <a href="mailto:email@email.com" class="text-muted">kushwahparag08@gmail.com</a>
          </div>
        </div><!-- end col -->
        ...
        <div class="col-sm-4">
          <div class="contact-detail-box">
            ...
            <address>
            	Eh-90, scheme-no-54, near bapat square<br>
        ...
        <div class="col-sm-4">
          <div class="contact-detail-box">
            ...
            <p>SRIJAN KHARE.</p>
            <h4 class="text-muted">7999892861</h4>
          </div>
        </div><!-- end col -->
